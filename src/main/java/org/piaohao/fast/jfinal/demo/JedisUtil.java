...
public class JedisUtil {
    ...
    static {
        ...
        REDIS_MAX_ACTIVE = 10000;
        REDIS_MAX_IDLE = 2000;
        REDIS_MAX_WAIT = 20000;
        REDIS_TIMEOUT = 20000;
        ...
        if (jedisPool == null) {
            ...
            config.setMaxWaitMillis((long) REDIS_MAX_WAIT);
    ...
    public class Keys {
        ...
        /*public void set(String key, Object obj) {
            ...
            byte[] bytes;
            try {
                bytes = FSTSerializerUtil.fastSerialize(obj);
            } catch (Exception var6) {
                return;
            }

            jedis.setnx(key.getBytes(), bytes);
        }*/
